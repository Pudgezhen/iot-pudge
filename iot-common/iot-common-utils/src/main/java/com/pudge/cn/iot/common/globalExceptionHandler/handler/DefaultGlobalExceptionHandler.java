...
import com.pudge.cn.iot.common.globalResponse.R;
...
public abstract class DefaultGlobalExceptionHandler {
    ...
    public R httpMessageNotReadableException(HttpMessageNotReadableException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.PARAM_EX.getCode(), StrPool.EMPTY, ExceptionCode.PARAM_EX.getMessage()).setPath(request.getRequestURI());
    }
    @ResponseBody
    ...
    public R illegalStateException(IllegalStateException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.ILLEGALA_ARGUMENT_EX.getCode(), StrPool.EMPTY, ExceptionCode.ILLEGALA_ARGUMENT_EX.getMessage()).setPath(request.getRequestURI());
    }
    @ResponseBody
    ...
    public R nullPointerException(NullPointerException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.NULL_POINT_EX.getCode(), StrPool.EMPTY, ExceptionCode.NULL_POINT_EX.getMessage()).setPath(request.getRequestURI());
    }
    @ResponseBody
    ...
    public R missingServletRequestPartException(MissingServletRequestPartException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), StrPool.EMPTY, ExceptionCode.REQUIRED_FILE_PARAM_EX.getMessage()).setPath(request.getRequestURI());
    }
    @ResponseBody
    ...
    public R servletException(ServletException ex, HttpServletRequest request) {
        ...
        if (msg.equalsIgnoreCase(ex.getMessage())) {
            return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), StrPool.EMPTY, ExceptionCode.REQUIRED_FILE_PARAM_EX.getMessage());
        }
    ...
    public R<String> otherExceptionHandler(Exception ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.SYSTEM_BUSY.getCode(), StrPool.EMPTY, ExceptionCode.SYSTEM_BUSY.getMessage()).setPath(request.getRequestURI());
    }
    ...
    public R<String> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.METHOD_NOT_ALLOWED.getCode(), StrPool.EMPTY, ExceptionCode.METHOD_NOT_ALLOWED.getMessage()).setPath(request.getRequestURI());
    }
    ...
    public R<String> persistenceException(PersistenceException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.SQL_EX.getCode(), StrPool.EMPTY, ExceptionCode.SQL_EX.getMessage()).setPath(request.getRequestURI());
    }
    @ResponseBody
